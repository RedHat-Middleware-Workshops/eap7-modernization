...
* https://github.com/tqvarnst/jboss-eap7-summit-lab/blob/master/exercise1-setup.adoc[Exercise 1 - Environment setup]
* https://github.com/tqvarnst/jboss-eap7-summit-lab/blob/master/exercise2-frontend.adoc[Exercise 2 - Java EE 7 Front-end technologies]
...
* https://github.com/tqvarnst/jboss-eap7-summit-lab/blob/master/exercise5-concurrency.adoc[Exercise 5 - Java EE Concurrency Utilities]
* https://github.com/tqvarnst/jboss-eap7-summit-lab/blob/master/exercise6-loadbalancing.adoc[Exercise 6 - Load-balancing]
* https://github.com/tqvarnst/jboss-eap7-summit-lab/blob/master/exercise7-clustering.adoc[Exercise 7 - Clustering]

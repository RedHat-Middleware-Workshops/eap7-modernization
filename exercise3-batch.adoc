...
image::images/03_01_import.png["JBDS import",600]

image::images/03_02_import.png["JBDS import 1/2",600]
...
+
.Deploy in JBDS
image::images/03_04_deploy.png["Deploy in JBDS",600]
...
+
.JBoss EAP 7 - Batch subsystem configuration
image::images/03_05_configuration.png["JBoss EAP 7 - Batch subsystem configuration",600]
...
+
.JBoss EAP 7 - Batch subsystem runtime metrics

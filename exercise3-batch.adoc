...
image::images/03_01_import.png[JBDS import 1/2]

image::images/03_02_import.png[JBDS import 2/2]
...
----
+
image::images/03_03_steps.png[Batch jobs in JBDS]
+
...
+
image::images/03_04_deploy.png[Deploy in JBDS]
...
+
image::images/03_05_configuration.png[JBoss EAP 7 - Batch subsystem configuration]
+
...
+
image::images/03_06_runtime.png[JBoss EAP 7 - Batch subsystem runtime metrics]
...
+
image::images/03_07_h2.png[h2console login]
+
...
Step 8 - Display all job details over the CLI::
+
